...
<h1><div align="center">Data Presensi</div></h1><br /><hr>
<table border="0" align="center">
<form action="index.php?act=absen" name="form" method="POST" >
  <tr>
    <td>
                           ...
                           echo 'Kelas Belum Di pilih';
                            ...
                            while($data = mysqli_fetch_assoc($sql)){ 
                                ...
                                <tr  class="odd gradeX" align=\"center\">
                                    ...
                                    <td><a href="?act=absen_rincian&nis=<?php echo $data['nis']; ?>&kelas=<?php echo$data['kode_kelas']; ?>" class="btn btn-primary btn-xs">Lihat</a></td>
                                    </tr>
                    <?php
                    }
                        }
