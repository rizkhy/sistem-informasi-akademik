...
<form name="form" id="form" class="form" action="input2_nilai.php" onKeyUp="highlight(event)"
	  onClick="highlight(event)" onsubmit="return validate(this)" method="get">
<table width="436" height="231" border="0" align="center" style="margin:20px">
  <tr>
	...
	<?php 
	$baris = mysqli_query("SELECT * FROM kelas");
	  while ($kelas = mysqli_fetch_array($baris)){
	  echo "<option value=\"$kelas[idRuang_Kelas]\">$kelas[nama_kelas]</option>";
	}
	?>
    </select>    </td>
  </tr>
