...
<form action="index.php?act=nilai_rekapitulasi" name="form" method="POST" >
  <tr>
    <td>
                           ...
                           echo 'Kelas Belum Di pilih';
                            ...
                            while($data = mysqli_fetch_assoc($sql)){ 
                                ...
                                <tr align=\"center\">
                                    ...
                                    <td><a href=index.php?act=nilai_rincian&nis=<?php echo $data['nis'] ?>&kelas=<?php echo $data['kode_kelas']?> class="btn btn-primary btn-xs">Lihat</a></td>
                                    </tr>
                    <?php }
                        }
