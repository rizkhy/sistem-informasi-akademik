...
--
-- Host: 127.0.0.1
-- Generation Time: 06 Jul 2018 pada 06.39
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=98129 ;
...
INSERT INTO `guru` (`nip`, `nama`, `password`, `alamat`) VALUES
...
--
ALTER TABLE `akun`
MODIFY `username` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=98129;
--
...
--
ALTER TABLE `siswa`
MODIFY `nis` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=98129;
--
