<?php
   ...
   $nis = str_replace('"','',$data);
    ...
    $query = "SELECT mata_pelajaran.nama_mp, kelas.nama_kelas, jadwal_pelajaran.hari, jadwal_pelajaran.jam FROM mata_pelajaran, kelas, jadwal_pelajaran, siswa WHERE mata_pelajaran.kode_mp=jadwal_pelajaran.kode_mp AND kelas.kode_kelas=jadwal_pelajaran.kode_kelas AND kelas.kode_kelas = siswa.kode_kelas AND siswa.nis = '$nis'";
     // echo $query;
     $data = array();
